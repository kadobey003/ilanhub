...
function ChannelCard({
  ...
  return (
    <a
      ...
      className={`group relative flex w-[78vw] max-w-[300px] shrink-0 snap-start flex-col overflow-hidden rounded-2xl bg-white shadow-lg shadow-sky-900/15 transition hover:-translate-y-1 hover:shadow-xl hover:shadow-sky-900/25 active:scale-[0.98] animate-fade-in opacity-0 sm:w-auto sm:max-w-none ${
